...
enum class MedicationEnum(val code: Int, val productName: String, val type: Int = Medication.OTHER) {
    ...
    AFREZZA(0, "Afrezza", Medication.LONG_ACTING_INSULIN),
    APIDRA(1, "Apidra", Medication.RAPID_ACTING_INSULIN),
    BASAGLAR(2, "Basaglar", Medication.LONG_ACTING_INSULIN),
    HUMALOG(3, "Humalog", Medication.INTERMEDIATE_ACTING_INSULIN),
    HUMALOG_MIX_50_50(4, "Humalog Mix 50/50", Medication.INTERMEDIATE_ACTING_INSULIN),
    HUMALOG_MIX_75_25(5, "Humalog Mix 75/25", Medication.INTERMEDIATE_ACTING_INSULIN),
    HUMULIN_R(6, "Humulin R", Medication.SHORT_ACTING_INSULIN),
    HUMULIN_N(7, "Humulin N", Medication.LONG_ACTING_INSULIN),
    ...
    NOVOLIN(12, "Novolin", Medication.RAPID_ACTING_INSULIN),
    ...
    TOUJEO(18, "Toujeo", Medication.SHORT_ACTING_INSULIN),
    TRESIBA(19, "Tresiba", Medication.SHORT_ACTING_INSULIN),
    VELOSULIN(20, "Velosulin")
}