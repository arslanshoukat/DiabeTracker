...
object TestData {
    ...
    val logEntry = LogEntry(
        ...
        dateTime = OffsetDateTime.parse("2019-08-19T22:52:30.725+05:00"), category = Category.AFTER_DINNER
    )
    ...
    val logEntry2 = LogEntry(
        ...
        dateTime = OffsetDateTime.parse("2019-08-21T10:23:40.245+05:00"), category = Category.AFTER_BREAKFAST
    )
